...
# start up the game in the room
# get data from game and send it up
# show status
...
def gameinfo(game, user_id):
	text = ''
	number = player_numbers[user_id]
	...
	text += 'Your cards: ' + unoparser.card_list_string(game.player_cards[number]) + '\n'
